      ...
      <PopoverTrigger asChild>
        <button
          ...
          className={`w-full flex items-center justify-between rounded-xl h-12 px-3 text-left text-sm
            bg-background border transition-colors shadow-sm
    ...
    <div className="flex justify-center gap-2" onPaste={handlePaste}>
      {values.map((val, i) => (
        <Input
          ...
          className="w-12 h-14 text-center text-xl font-bold bg-background border-border focus:border-primary/50 rounded-xl shadow-sm"
          autoFocus={i === 0}
        />
      ))}
    </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-center items-center px-12 xl:px-16 w-full">
            ...
            <motion.div
              ...
              className="mt-10 flex items-center gap-2 text-xs text-muted-foreground bg-muted/50 dark:bg-secondary/30 px-4 py-2 rounded-full border border-border"
            >
              ...
              {step === 'form' && (
                <motion.div key="form" exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }}>
                      ...
                      {socialProviders.map((sp) => {
                        ...
                        return (
                          <Button
                            ...
                            className="h-11 rounded-xl border-border bg-background hover:bg-accent/50 transition-all duration-200 flex items-center justify-center gap-2 text-sm font-medium shadow-sm"
                          >
                            {isLoading ? (
                  ...
                  <motion.form variants={fadeInUp} onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`pl-10 bg-background border-border focus:border-primary/50 rounded-xl h-11 shadow-sm ${touched.name && errors.name ? 'border-destructive' : ''}`}
                          disabled={loading}
                          required
                        />
                      </div>
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          ...
                          <Input
                            ...
                            className={`pl-10 bg-background border-border focus:border-primary/50 rounded-xl h-11 shadow-sm ${emailVerified ? 'border-emerald-500/50' : touched.email && errors.email ? 'border-destructive' : ''}`}
                            disabled={loading}
                            required
                          />
                        </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`pl-10 bg-background border-border focus:border-primary/50 rounded-xl h-11 shadow-sm ${touched.phone && errors.phone ? 'border-destructive' : ''}`}
                          disabled={loading}
                          maxLength={16}
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`pl-10 pr-10 bg-background border-border focus:border-primary/50 rounded-xl h-11 shadow-sm ${touched.password && errors.password ? 'border-destructive' : ''}`}
                          disabled={loading}
                          required
                        />
                        <button
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`pl-10 bg-background border-border focus:border-primary/50 rounded-xl h-11 shadow-sm ${touched.confirmPassword && errors.confirmPassword ? 'border-destructive' : touched.confirmPassword && !errors.confirmPassword && confirmPassword ? 'border-emerald-500/50' : ''}`}
                          disabled={loading}
                          required
                        />
                      </div>
                    ...
                    {/* Password requirements */}
                    {password.length > 0 && (
                      <div className="space-y-1.5 p-3 rounded-xl bg-muted/50 dark:bg-secondary/20 border border-border">
