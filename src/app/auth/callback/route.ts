...
<body style="display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;font-family:system-ui,sans-serif;background:#0a0a0a;color:#fafafa">
  ...
  // Redirect to the proper /dashboard route (not hash-based)
  const response = NextResponse.redirect(new URL('/dashboard', request.url))

  // Set httpOnly session cookie (secure, like the login flow)
  ...
  // Also set a readable cookie for user data (for client-side AuthContext)
