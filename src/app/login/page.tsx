                ...
                {socialProviders.map((sp) => {
                  ...
                  return (
                    <Button
                      ...
                      className="h-12 rounded-xl border-border bg-background hover:bg-accent/50 transition-all duration-200 flex items-center justify-center gap-2 text-sm font-medium shadow-sm"
                    >
                      {isLoading ? (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-background border-border focus:border-primary/50 rounded-xl h-12 shadow-sm"
                    disabled={loading}
                    autoComplete="email"
                    required
                  />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-background border-border focus:border-primary/50 rounded-xl h-12 shadow-sm"
                    disabled={loading}
