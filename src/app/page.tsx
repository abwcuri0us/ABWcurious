...
export default function Home() {
  ...
  return (
    <div className="home-page">
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            <div className="col-lg-6">
              ...
              <motion.p 
                className="lead mb-4 text-light fw-medium"
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
      ...
      >
        <div className="container">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <p className="lead text-light fw-medium w-75 mx-auto">We offer a comprehensive range of services designed to meet your learning and development needs.</p>
          </motion.div>
      ...
      <motion.section 
        className="py-5 glass-panel mt-5 border-start-0 border-end-0 border-bottom-0"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true, margin: "-100px" }}
      >
        <div className="container text-center text-white">
          <motion.h2 
            className="display-5 text-white mb-3 fw-bold" style={{ textShadow: '0 0 10px rgba(255,255,255,0.3)' }}
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            viewport={{ once: true }}
