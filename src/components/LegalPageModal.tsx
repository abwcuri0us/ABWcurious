...
const EFFECTIVE_DATE = 'January 1, 2023';
            ...
            content: (
              <>
                ...
                <p>
                  ...
                  information shared through our website, newsletters, and other content
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div
              className="relative w-full max-w-3xl max-h-[90vh] glass-card overflow-hidden flex flex-col"
              ...
              <div className="flex-shrink-0 px-6 sm:px-8 py-4 border-t border-border bg-secondary/20">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
                  <p className="text-xs text-muted-foreground">
                    &copy; 2023–{new Date().getFullYear()} {COMPANY}. All rights reserved.
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Questions?{' '}
                    <a href={`mailto:${EMAIL}`} className="text-primary hover:underline">
