...
export default function AboutSection() {
  return (
    <section id="about" aria-label="About" className="relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.h3
            ...
            style={{ fontFamily: "var(--font-space-grotesk)" }}
          >
            Our <span className="text-gradient-cyan">Journey</span>
          </motion.h3>
          ...
          <div className="hidden md:block relative">
            ...
            <div className="absolute top-1/2 left-0 right-0 h-[2px] -translate-y-1/2">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, var(--glow-color), rgba(0,102,255,0.2), var(--glow-color), transparent)",
                }}
              />
              <div
            ...
            <div className="relative grid grid-cols-5 gap-2 sm:gap-4">
              {milestones.map((ms, i) => (
                ...
                >
                  ...
                  {/* Card */}
                  <div className="glass-card p-2 sm:p-4 text-center w-full hover:border-primary/20 transition-all duration-300">
                    <h4
                      className="text-xs sm:text-sm font-bold text-primary mb-0.5 sm:mb-1"
                      style={{ fontFamily: "var(--font-space-grotesk)" }}
                    >
                      {ms.label}
                    </h4>
                    <p className="text-foreground/70 text-[10px] sm:text-xs leading-relaxed">
                      {ms.desc}
                    </p>
                  </div>
                </motion.div>
          ...
          <div className="md:hidden relative pl-8">
            ...
            <div className="absolute left-3 top-0 bottom-0 w-[2px]">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, var(--glow-color), rgba(0,102,255,0.2), var(--glow-color))",
                }}
              />
            </div>
