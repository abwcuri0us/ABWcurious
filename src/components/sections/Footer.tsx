...
const serviceLinks = [
  { label: 'AI and Machine Learning', href: '/services/ai-solutions' },
  { label: 'Electronic Security', href: '/services/iot' },
  { label: 'Cyber Security', href: '/cybersecurity' },
  { label: 'Website Development', href: '/services/website-development' },
  { label: 'Application Development', href: '/services/mobile-apps' },
  { label: 'IT Supports', href: '/services/maintenance-support' },
  { label: 'Digital Marketing', href: '/services/digital-marketing' },
  { label: 'Cloud Solutions', href: '/services/cloud-solutions' },
  { label: 'Hiring & Career Guidance', href: '/careers' },
];
...
const researchCareerLinks = [
  ...
  { label: 'Internships', href: '/internship', external: false },
...
export default function Footer() {
  ...
  const handleLinkClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string, external?: boolean) => {
    ...
    e.preventDefault();
    // Internal app routes (start with '/') — navigate via router
    if (href.startsWith('/')) {
      router.push(href);
      return;
    }
    // Legacy hash anchors — smooth-scroll if the element exists on this page
    if (href.startsWith('#')) {
  ...
  return (
    <footer className="relative bg-background mt-auto">
      ...
      {/* Landscape Animation */}
      <div className="absolute bottom-0 left-0 w-full overflow-hidden pointer-events-none" style={{ height: '120px', zIndex: 0, opacity: 0.2 }}>
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="absolute bottom-0 w-full h-full">
          <path d="M0,120 V80 Q100,50 300,70 T600,60 T900,80 T1200,60 V120 Z" fill="var(--primary)" opacity="0.3">
            <animate attributeName="d" dur="10s" repeatCount="indefinite" values="
              M0,120 V80 Q100,50 300,70 T600,60 T900,80 T1200,60 V120 Z;
              M0,120 V70 Q100,90 300,60 T600,80 T900,50 T1200,70 V120 Z;
              M0,120 V80 Q100,50 300,70 T600,60 T900,80 T1200,60 V120 Z
            " />
          </path>
          <path d="M0,120 V90 Q150,70 350,90 T700,80 T1000,100 T1200,80 V120 Z" fill="var(--accent)" opacity="0.4">
            <animate attributeName="d" dur="15s" repeatCount="indefinite" values="
              M0,120 V90 Q150,70 350,90 T700,80 T1000,100 T1200,80 V120 Z;
              M0,120 V80 Q150,100 350,70 T700,90 T1000,70 T1200,90 V120 Z;
              M0,120 V90 Q150,70 350,90 T700,80 T1000,100 T1200,80 V120 Z
            " />
          </path>
        </svg>
