        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-5">
          {techItems.map((tech, i) => (
            ...
            >
              ...
              />
              <div className="relative rounded-lg p-1.5 bg-white dark:bg-gray-900 border border-border/50">
                <img
                  src={tech.logoUrl}
                  alt={`${tech.name} logo`}
                  width={36}
                  height={36}
                  className={`w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 object-contain transition-transform duration-300 group-hover:scale-110 ${
