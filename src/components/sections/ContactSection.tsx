...
const contactDetails = [
  ...
  },
  {
    ...
    href: 'https://maps.app.goo.gl/W15b49Fj4oWw1yK5A',
  },
];
...
const socialLinks = [
  ...
  { icon: XLogo, href: 'https://x.com/abwcurious', label: 'X' },
];

const internshipFormUrl =
  'https://docs.google.com/forms/d/e/1FAIpQLSd6d_0Rpq0mt6UKqt9oM9eMwvoaGBZkbTpGlXshFBHFGc6G-';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
              ...
              {contactDetails.map((item, i) => (
                ...
                >
                  {item.href ? (
                    <a
                      href={item.href}
                      className="glass-card flex items-center gap-4 p-4 sm:p-5 group hover:border-primary/20 transition-all duration-500"
                    >
                    ...
                    <div className="glass-card flex items-center gap-4 p-4 sm:p-5 group hover:border-primary/20 transition-all duration-500">
                      <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-primary/10 text-primary flex items-center justify-center">
                        <item.icon className="w-5 h-5" />
                      </div>
                      <div>
            ...
            <motion.div
              ...
              variants={fadeUp}
              className="glass-card overflow-hidden rounded-2xl hover:border-primary/20 transition-all duration-500"
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60330.36010259671!2d72.99855994479903!3d19.07922964808617!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c3d076147f7b%3A0xe421751ae4517f6d!2sABWcurious%20Pvt.Ltd!5e0!3m2!1sen!2sin!4v1785227290823!5m2!1sen!2sin"
                width="100%"
                height="220"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="ABWcurious Office Location"
                className="rounded-2xl"
              />
            </motion.div>

            {/* Internship CTA removed */}
              ...
              <div className="flex flex-wrap gap-3">
                {socialLinks.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    className="w-10 h-10 rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/20 transition-all duration-300"
                  >
