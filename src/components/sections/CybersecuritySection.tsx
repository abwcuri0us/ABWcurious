    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <span className="text-gradient-cyan">Enterprise-Grade</span>{" "}
            Cyber Defense & Threat Management
          </h2>
          <p className="text-foreground/80 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
            End-to-end cybersecurity resilience — from proactive threat intelligence and 
            vulnerability assessment to real-time incident response and compliance management.
          </p>
        </motion.div>
        ...
        {(activeTab === 'services' || activeTab === null) && (
          <motion.div
            className="cyber-tab-content"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {(activeTab === 'stats' || activeTab === null) && (
          <motion.div
            className="cyber-tab-content"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {(activeTab === 'trust' || activeTab === null) && (
          <motion.div
            className="cyber-tab-content"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
