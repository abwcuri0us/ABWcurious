...
const products: Product[] = [
  {
    ...
    url: 'https://cyberintelligence360.abwcurious.com',
    icon: ShieldCheck,
  ...
  {
    name: 'TheCodeArena',
    url: 'https://www.thecodearena.co.in/',
    icon: Swords,
  ...
  {
    name: 'Restaurant360',
    url: 'https://restaurant360.abwcurious.com',
  ...
  {
    name: 'KapiKitab',
    url: 'https://kapikitab.vercel.app',
    icon: BookOpen,
    ...
    description:
      'Digital knowledge management and book discovery platform. Explore, organize, and share your reading journey with a modern, intuitive interface.',
    tags: ['Knowledge Management', 'Book Discovery', 'Digital Library', 'Reading'],
  },
  {
    name: 'IntelliQR',
    url: '/products/intelliqr',
    icon: Code2,
    ...
    description:
      'Dynamic QR codes with real-time analytics, campaign tracking, and smart redirect capabilities for modern marketing and operations.',
    tags: ['QR Codes', 'Analytics', 'Marketing', 'Smart Redirect'],
  },
];
      ...
      >
        ...
        >
          ...
          <div className="mb-5 relative inline-flex">
            ...
            />
            <div
              className="relative flex items-center justify-center w-14 h-14 rounded-xl border transition-colors duration-300 overflow-hidden"
              style={{
    ...
    <section id="products" className="relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <span className="text-gradient-holographic">Innovative</span>{' '}
