              ...
              <React.Fragment key={badge.id}>
                ...
                >
                  ...
                  >
                    ...
                    {/* Real Logo Image */}
                    <div
                      className="relative mb-3 rounded-lg p-3 transition-all duration-300 group-hover:drop-shadow-[0_0_12px_var(--glow-color)] bg-white dark:bg-gray-900 border border-border/50"
                    >
                      <Image
                        src={badge.logoSrc}
